...
export default function ManagerDashboardPage() {
  ...
  if (loading) {
    return (
      <ManagerLayout title="Dashboard" subtitle="Loading...">
  ...
  if (error) {
    return (
      <ManagerLayout title="Dashboard" subtitle="Error loading data">
  ...
  return (
    <ManagerLayout title="Dashboard" subtitle="Welcome back! Here's your overview.">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat) => (
